...
public:
    ...
    void step(double steps, bool emission);
    std::pair<int, int> simulate(double t1, double t2);
...
private:
    ...
    void process_transition(const std::string &selected_transition, bool emission);
    void process_laser_excitation(const std::string &selected_transition);
    void process_decay(const std::string &selected_transition, bool emission);
