...
int main() {
    std::cout << "Successfully import:\n" << std::endl;
    std::cout << "Tm_energy" << std::endl;
    std::cout << "Tm_RME" << std::endl;
    std::cout << "Tm_omega" << std::endl;
    std::cout << std::endl;

    // Yb inf
    std::map<std::string, double> Yb_energy = {
        {"S0", 0},
        {"S1", 10246}
    };

    std::map<std::string, int> Yb_g = {
        {"S1", 6}
    };
    ...
    // Intensity parameter
    std::map<std::string, double> Tm_omega = {
        {"2", 2.04e-20},
        {"4", 2.01e-20},
        {"6", 1.44e-20}
    };
    ...
    std::map<std::string, double> Tm_energy = {
        {"E0(3H6)", 153}, {"E1(3F4)", 5828}, {"E2(3H5)", 8396},
        {"E3(3H4)", 12735}, {"E4(3F3)", 14598}, {"E5(3F2)", 15180},
        {"E6(1G4)", 21352}, {"E7(1D2)", 28028}, {"E8(3P0)", 34900},
        {"E9(1I6)", 35500}, {"E10(3P1)", 36400}, {"E11(3P2)", 38250}
    };

    std::map<std::string, std::vector<double>> Tm_RME = {
        {"E1E0", {0.527, 0.718, 0.228}},
