...
def MD_cal(energy_dict, n):
    ...
    for i in pairs:
        ...
        start_E = start_level[0 : start_level.find('(')] # E2
        end_E = end_level[0 : end_level.find('(')] # E0
        key =  start_E + end_E # E2E0
        
        start_symbol= start_level[start_level.find('(') + 1:-1] # 3H5
        end_symbol= end_level[end_level.find('(') + 1:-1] # 3H6
